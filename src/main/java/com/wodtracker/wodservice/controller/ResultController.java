...
public class ResultController {
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Update a WOD result", security = @SecurityRequirement(name = "bearerAuth"))
    public ResponseEntity<ResultResponseDTO> updateResult(@PathVariable Long id, @Valid @RequestBody ResultRequestDTO requestDTO) {
